...
- Severity counts are generated by `slopgate --list-rules`.
...
| Extended parity checks | `SLP081`–`SLP140` | React/API/auth/audit/pagination/concurrency and newer overlap-driven checks |
